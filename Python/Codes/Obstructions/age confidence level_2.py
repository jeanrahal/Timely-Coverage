...
def findPixelsofInterestPerSensor(labeledMatrixPixel,unwantedPixelsCorners1,intersection_sizes,N):
    ...
    for sensor in range(N):
        ...
        obstructedPixelsPerSensors[sensor].append([label_pixel_road1_left,label_pixel_road1_right,label_pixel_road2_up,label_pixel_road2_down])
        index_obstructedPixelsPerSensors[sensor].append([index_pixel_road1_left,index_pixel_road1_right,index_pixel_road2_up,index_pixel_road2_down])
...
def placeWeightPerSensor(labeledMatrixPixel,unwantedPixelsCorners1,intersection_sizes,N):
    ...
    for sensor in range(N):
        ...
        weightedRegionsPerSensor[sensor] = 1/4
...
def weightPixels(obstructedPixelsinBox,index_obstructedPixelsPerSensorsinBox,weightedRegionsPerSensor,labeledMatrixPixel,unwantedPixelsCorners1,intersection_sizes,N):
    ...
    for sensor in range(N):
        ...
        index_pixel_road1_left = index_obstructedPixelsPerCurrentSensor[0][0]
        index_pixel_road1_right = index_obstructedPixelsPerCurrentSensor[0][1]
        index_pixel_road2_up = index_obstructedPixelsPerCurrentSensor[0][2]
        index_pixel_road2_down = index_obstructedPixelsPerCurrentSensor[0][3]
        
        weightPerCurrentSensorRegion = weightedRegionsPerSensor[sensor]
        # Weight the corresponding pixels
        weightedMap[int(np.shape(labeledMatrixPixel)[0]-1-index_pixel_road1_left[1])][int(index_pixel_road1_left[0])] += weightPerCurrentSensorRegion
        weightedMap[int(np.shape(labeledMatrixPixel)[0]-1-index_pixel_road1_right[1])][int(index_pixel_road1_right[0])] += weightPerCurrentSensorRegion
        ...
        weightedMap[int(np.shape(labeledMatrixPixel)[0]-1-index_pixel_road2_down[1])][int(index_pixel_road2_down[0])] += weightPerCurrentSensorRegion
