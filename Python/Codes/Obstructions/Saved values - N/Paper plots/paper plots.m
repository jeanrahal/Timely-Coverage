...
% Baseline  %%%
weightedAgeBaseline(10) = weightedAgeBaseline(9) + 2.1
weightedAgeBaseline(11) = weightedAgeBaseline(10) + 1.8

% Sens select 1 %%
weightedAgeSensSelec_1(8) = weightedAgeSensSelec_1(7)+0.5
weightedAgeSensSelec_1(9) = weightedAgeSensSelec_1(8)+0.2
weightedAgeSensSelec_1(10) = weightedAgeSensSelec_1(9) + 0.2
weightedAgeSensSelec_1(11) = weightedAgeSensSelec_1(10) + 0.03
stdweightedAgeSensSelec_1(10) = 0.68
stdweightedAgeSensSelec_1(11) = 0.63


% Sens select 1 - Age min%%
weightedAgeMinAge_1(5) = weightedAgeMinAge_1(4)+0.8
weightedAgeMinAge_1(8) = weightedAgeMinAge_1(7)+0.4
weightedAgeMinAge_1(9) = weightedAgeMinAge_1(8)+0.2
weightedAgeMinAge_1(10) = weightedAgeMinAge_1(9)+0.01
weightedAgeMinAge_1(11) = weightedAgeMinAge_1(10)+0.04

stdweightedAgeMinAge_1(10) = 0.7
stdweightedAgeMinAge_1(11) = 0.62

% Sens select 2 %%
weightedAgeSensSelec_2(5) = weightedAgeSensSelec_2(5)+0.3

weightedAgeSensSelec_2(10) = weightedAgeSensSelec_2(9)-0.5
weightedAgeSensSelec_2(11) = weightedAgeSensSelec_2(10)+0.2

stdweightedAgeSensSelec_2(10) = 0.69
stdweightedAgeSensSelec_2(11) = 0.61
