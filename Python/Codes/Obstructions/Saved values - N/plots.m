...
figure;
errorbar(N,100-coverageAreaObstructions_1(8:18)); hold on; grid on;
errorbar(N,100-coverageAreaObstructions_2(8:18));
...
figure();
plot(N,coverageAreaBaseline(8:18)); hold on; grid on;
plot(N,noCollabCoverageTypicalSensor(8:18));
errorbar(N,coverageTypicalSensorSensSelec_1(8:18));
errorbar(N,coverageTypicalSensorSensSelec_2(8:18));
...
errorbar(N , weightedAgeSensSelec_1);
errorbar(N , weightedAgeMinAge_1);
errorbar(N , weightedAgeSensSelec_2);
